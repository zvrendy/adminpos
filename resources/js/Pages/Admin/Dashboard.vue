                ...
                <div class="card">
                    ...
                    <ul class="products-list product-list-in-card pl-2 pr-2">
                        ...
                        <div class="product-img">
                            <img
                            :src="'/storage/default-150x150.png'"
                            alt="Product Image"
                            class="img-size-50"
                            />
                        </div>
