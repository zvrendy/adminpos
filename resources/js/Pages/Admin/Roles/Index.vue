                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <button type="button" class="btn btn-info text-uppercase" style="letter-spacing: 0.1rem;" @click="openModal">
                                        Add
                                    </button>
                                </div>
                            </div>
                                        ...
                                        <tr v-for="(role, index) in roles" :key="index">
                                            ...
                                            <td>
                                                <div class="d-flex flex-column">
                                                    <span :key="index" v-for="(permission, index) in role.permissions">
                                                        {{ permission.name }}
                                                    </span>
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-right">
                                                <button type="button" class="btn btn-success text-uppercase" style="letter-spacing: 0.1em;" @click="editRole(role)">
                                                    Edit
                                                </button>
                                                <button type="button" class="btn btn-danger text-uppercase ml-1" style="letter-spacing: 0.1em;">
                                                    Delete
                                                </button>
                                            </td>
                                        </tr>
                            ...
                            <form @submit.prevent="createRole">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <multiselect
                                        v-model="form.permissions" :options="permissionOptions" :multiple="true" :taggable="true" placeholder="Choose Permission(s)" @addPermissions="addPermissions" label="name" track-by="id">
                                        </multiselect>
                                    </div>
                                    <div class="invalid-feedback" :class="{ 'd-block':form.errors.permissions }">{{ form.errors.permissions }}</div>
                                </div>
                                <div class="modal-footer justify-content-between">
                                    ...
                                    <button type="submit" class="btn btn-info text-uppercase" style="letter-spacing: 0.1em;">Save</button>
                                </div>
                            </form>
                        </div>
                    </div>
